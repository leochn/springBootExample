...
public class JsonResult {
	...
	public JsonResult(Integer total,Object data) {
		this.status = 200;
		this.msg = "OK";
		this.total = total;
		this.data = data;
	...
	public JsonResult(Integer status, String msg, Integer total,Object data) {
		this.status = status;
		this.msg = msg;
		this.total = total;
		this.data = data;
	...
	public static JsonResult ok(Integer total,Object data) {
		return new JsonResult(total,data);
	}
